  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cockpit px-4">
      <div className="max-w-md w-full carbon-card rounded-xl p-8">
        <h1 className="text-2xl font-bold text-titanium mb-2">Create Account</h1>
        <p className="text-titanium/60 mb-6">Get started with Recover today</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mb-6">
          ...
          <div>
            <label htmlFor="orgName" className="block text-sm font-medium text-titanium mb-2">
              Organization Name
            </label>
            <input
              id="orgName"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-titanium mb-2">
              Confirm Password
            </label>
            <input
              id="confirmPassword"
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-cockpit text-titanium/60">Or sign up with</span>
          </div>
        </div>
        ...
        >
          ...
          <span className="text-titanium">Sign up with Google</span>
        </button>

        <p className="text-center text-titanium/60 text-sm mt-6">
          Already have an account?{' '}
          <Link href="/auth/signin" className="text-signal hover:text-signal/80">
            Sign in
          </Link>
        </p>
      </div>
